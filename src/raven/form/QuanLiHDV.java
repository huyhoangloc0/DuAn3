...
public class QuanLiHDV extends TabbedForm {
    ...
    private void initComponents() {
        ...
        txtmahdv = new raven.swing.MyTextField();
        myButton3 = new raven.swing.MyButton();
        btnUpdate = new raven.swing.MyButton();
        lb4 = new javax.swing.JLabel();
        txttenhdv = new raven.swing.MyTextField();
        ...
        txttdhv = new raven.swing.MyTextField();
        lb13 = new javax.swing.JLabel();
        txtkndb = new raven.swing.MyTextField();
        ...
        jLabel1.setText("Quản lí Hướng Dẫn Viên");

        lb3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lb3.setForeground(new java.awt.Color(153, 153, 153));
        lb3.setText("Mã hướng dẫn viên");

        txtmahdv.setCaretColor(new java.awt.Color(0, 51, 51));
        txtmahdv.setShadowColor(new java.awt.Color(0, 0, 255));
        ...
        lb12.setText("Trình độ học vấn");

        txttdhv.setShadowColor(new java.awt.Color(0, 0, 255));

        lb13.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lb13.setForeground(new java.awt.Color(153, 153, 153));
        lb13.setText("Kỹ năng đặc biệt");

        txtkndb.setShadowColor(new java.awt.Color(0, 0, 255));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lb3)
                                    .addComponent(txtmahdv, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txttenhdv, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lb8)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(lb4)
                                        .addGap(18, 18, 18)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(lb13)
                                            .addComponent(txttdhv, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(lb12)
                                            .addComponent(txtkndb, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lb3)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtmahdv, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lb8)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txttenhdv, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lb12)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txttdhv, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lb10)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addComponent(lb13)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtkndb, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
...
//       }
    ...
    private raven.swing.MyTextField txtkndb;
    private raven.swing.MyTextField txtmahdv;
    private raven.swing.MyTextField txtname7;
    private raven.swing.MyTextField txtnamsinh;
    private raven.swing.MyTextField txttdhv;
    private raven.swing.MyTextField txttenhdv;
...
ArrayList<Model_HuongDanVien> list = new ArrayList<>();
int row = 0;
int current = 0;
private void load_data() throws SQLException{
    try {
            ...
            list.clear();
            while (rs.next()) {
                Model_HuongDanVien nv = new Model_HuongDanVien();
                nv.setMahdv(rs.getString("mahdv"));
                nv.setTenhdv(rs.getString("tenhdv"));
                nv.setGioitinh(rs.getBoolean("gioitinh"));
                nv.setSdt(rs.getString("namsinh"));
                nv.setEmail(rs.getString("email"));
                nv.setNamsinh(rs.getString("sdt"));
                nv.setDiachi(rs.getString("diachi"));
                nv.setTrinhdohocvan(rs.getString("trinhdohocvan"));
                nv.setKynangdatbiet(rs.getString("kynangdatbiet"));
                list.add(nv);

            }
            DefaultTableModel model = (DefaultTableModel) tbl.getModel();
            model.setRowCount(0);
            for (Model_HuongDanVien nv : list) {
                Object[] row = new Object[]{nv.getMahdv(), nv.getTenhdv(), nv.isGioitinh()?"Nam":"Nữ", nv.getSdt(), nv.getEmail(), nv.getNamsinh(), nv.getDiachi(), nv.getTrinhdohocvan(), nv.getKynangdatbiet()};
                model.addRow(row);
            }
            rs.close();
            ps.close();
    ...
    Model_HuongDanVien getForm(){
        Model_HuongDanVien model = new Model_HuongDanVien();
        model.setMahdv(txtmahdv.getText());
        model.setTenhdv(txttenhdv.getText());
        model.setGioitinh(rdNam.isSelected());
        model.setSdt(txtdienthoai.getText());
        model.setEmail(txtEmail.getText());
        model.setNamsinh(txtnamsinh.getText());
        model.setDiachi(txtdiachi.getText());
        model.setTrinhdohocvan(txttdhv.getText());
        model.setKynangdatbiet(txtkndb.getText());
        return model;
    }
    void setForm(Model_HuongDanVien model){
        txtmahdv.setText(model.getMahdv());
        txttenhdv.setText(model.getTenhdv());
        rdNam.setSelected(model.isGioitinh());
        txtdienthoai.setText(model.getSdt());
        txtEmail.setText(model.getEmail());
        txtnamsinh.setText(model.getNamsinh());
        txtdiachi.setText(model.getDiachi());
        txttdhv.setText(model.getTrinhdohocvan());
        txtkndb.setText(model.getKynangdatbiet());
    }
    
    void updateStatus(boolean edit){
        txtmahdv.setEditable(edit);
    ...
    void insert(){
        Model_HuongDanVien model = getForm();
        try {
            PreparedStatement ps = JDBC.getJdbc().getConnection().prepareStatement("INSERT INTO HuongDanVien (Mahdv, Tenhdv, GioiTinh, Sdt, Email, Namsinh, Diachi, Trinhdohocvan, Kynangdatbiet)"
                 + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ps.setString(1, model.getMahdv());
            ps.setString(2, model.getTenhdv());
            ...
            ps.setString(8, model.getTrinhdohocvan());
            ps.setString(9, model.getKynangdatbiet());
    ...
    void update(){
        Model_HuongDanVien model = getForm();
        try {
            PreparedStatement ps = JDBC.getJdbc().getConnection().prepareStatement("UPDATE HuongDanVien SET Tenhdv = ?, GioiTinh = ?, Sdt = ?, Email = ?, Namsinh = ?, Diachi = ?, Trinhdohocvan = ?, Kynangdatbiet = ? "
                 + "WHERE Mahdv = ?");
            ps.setString(1, model.getMahdv());
            ps.setString(2, model.getTenhdv());
            ps.setBoolean(3, model.isGioitinh());
    ...
    void delete(){
        ...
        try {
            PreparedStatement ps = JDBC.getJdbc().getConnection().prepareStatement("DELETE FROM HuongDanVien WHERE Mahdv = ?");
            ps.setString(1, txtmahdv.getText());
            int result = ps.executeUpdate();
            if (result > 0) {
                load_data();
    ...
    if (selectedRow >= 0) {
        ...
        String tenhdv = model.getValueAt(selectedRow, 1).toString();
        ...
        String trinhdohocvan = model.getValueAt(selectedRow, 7).toString();
        String kynangdatbiet = model.getValueAt(selectedRow, 8).toString();
        ...
        txttdhv.setText(trinhdohocvan);
        txtkndb.setText(kynangdatbiet);
